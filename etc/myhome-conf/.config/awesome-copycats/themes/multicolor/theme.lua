...
theme.wallpaper                                 = theme.confdir .. "/wall2.jpge"
--theme.font                                      = "xos4 Terminus 8"
theme.font                                      = "Misc Tamsyn 10.5"
theme.menu_bg_normal                            = "#000000"
theme.menu_bg_focus                             = "#000000"
theme.bg_normal                                 = "#000000"
theme.bg_focus                                  = "#663300"
...
local mytextclock = wibox.widget.textclock(markup("#7788af", "%A %m月%d日 ") .. markup("#535f7a", ">") .. markup("#de5e1e", " %H:%M "))
...
theme.weather = lain.widget.weather({
    city_id = 1810821, -- placeholder (FuZhou)
